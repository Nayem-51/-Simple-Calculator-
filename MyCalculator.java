...
class MyCalculator implements ActionListener {
    JFrame f;
    JTextField t;
    JButton b1, b2, b3, b4, b5, b6, b7, b8, b9, b0, badd,
            bsub, bmul, bdiv, beq, bdel, bdec, bclr;
    ...
    MyCalculator() {
        ...
        // Initializing buttons with their labels
        b1 = new JButton("1");
        b2 = new JButton("2");
        b3 = new JButton("3");
        b4 = new JButton("4");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == bdel) {
            String s = t.getText();
            if (s.length() > 0) {
                t.setText(s.substring(0, s.length() - 1)); // Fixed delete function
            }
        }
